# Build the HAY STAR native engine (aarch64 shared library) with the Android NDK.
# Output: native/build/libmstar.so  (arm64-v8a, loaded into the game under Houdini)
...
$soPath = Join-Path $out "libmstar.so"
